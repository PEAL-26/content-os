                ...
                <div className={`rounded-md p-3 text-sm ${scope === 'workspace' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-50 text-gray-700'}`}>
                    {scope === 'workspace' ? (
                        <span className="flex items-center gap-2">
                            ...
                            <span>
                                <strong>Provedor do workspace</strong> — visível a todos os membros. Só o proprietário do workspace gere estes provedores. A chave fica associada à tua conta e só o teu utilizador a usa.
                            </span>
                        </span>
                    ) : (
                        <span className="flex items-center gap-2">
